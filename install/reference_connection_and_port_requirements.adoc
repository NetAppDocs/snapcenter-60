...
This is an internal port that is used only on the NetApp supported plug-in host; no firewall exception is required.

Communication between the SnapCenter Server and NetApp supported plug-ins is routed through port 8145.
